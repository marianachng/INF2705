...
public:
    ...
    static int texnumero;             // numéro de la texture utilisée: 0-aucune, 1-mario, 2-soleil
    static GLuint textureMARIO;       // la texture mario
    static GLuint textureSOLEIL;      // la texture soleil
